...
#Created by Colin may, Claudia Rojas, Nick Bradford
<!DOCTYPE html>
<html>
  <head>
...
if ($_SERVER[ 'REQUEST_METHOD' ] == 'POST') {
    ...
    if(!empty($lName) && !empty($fName) && !empty($number)) {
      $result = insert_record($dbc, $number, $fName, $lName) ;

      #echo "<p>Added " . $result . " new print(s) ". $name . " @ $" . $price . " .</p>" ;
    }
    else
      echo '<p style="color:red">Please input a particular President\'s number, first and last names </p>' ;
}
